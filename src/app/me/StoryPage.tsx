    ...
    <div className="max-w-[1000px] mx-auto mt-12">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="bg-green-600 hover:bg-green-700 px-4 py-[6px] rounded-full text-white text-sm"
        >
          New Story+
        </button>
      </div>
      <div className="flex items-center space-x-6 border-b-[1px] mt-2">
        <Link
          ...
          className={`${
            path === "drafts"
              ? "border-b-[1px] border-neutral-800 opacity-100"
              : "opacity-60"
          } text-sm pb-4`}
        >
          drafts {TotalDrafts}
